...
@Component({
  ...
  template: `
    <div class="flex flex-col items-center justify-between flex-1 min-h-full w-full max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 py-6 sm:py-8 text-white select-none gap-6">
      ...
      <div class="flex-1 flex flex-col items-center justify-center text-center gap-6 sm:gap-8 kiosk:gap-12 max-w-2xl kiosk:max-w-4xl my-auto w-full px-2">
        ...
        <div class="space-y-4 sm:space-y-6 kiosk:space-y-8 flex flex-col items-center w-full">
          ...
          <div class="inline-flex flex-col items-center justify-center gap-3 sm:gap-4 kiosk:gap-5 pt-1 sm:pt-2">
