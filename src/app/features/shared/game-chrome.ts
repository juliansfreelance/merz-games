...
@Component({
  ...
  imports: [CommonModule, KioskDisclaimer],
  host: {
  ...
  template: `
    <div class="w-full flex-1 min-h-full flex flex-col justify-between p-3 sm:p-4 lg:p-6 text-white select-none gap-4 sm:gap-6">
      ...
      >
        <button
          type="button"
          class="text-neutral-400 font-bold tracking-wider uppercase hover:text-white active:scale-95 active:text-neutral-200 text-xs sm:text-sm transition-all duration-150 py-1 px-4 cursor-pointer select-none [&>span>sup]:text-[0.6em] [&>span>sup]:top-[-0.4em] [&>span>sup]:font-normal"
          (click)="back.emit()"
        >
